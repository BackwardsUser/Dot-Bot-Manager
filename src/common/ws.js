...
function _init() {
    ...
    _connection.on('error', () => {
        ...
        setTimeout( () => {
            if (reconnecting == settings.reconnect_attempts) return console.error("Unable to connect to server."), getInternetConnection();
